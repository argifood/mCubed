...
"""
TCP Server gia multithread tasks
...
def accept_incoming_connections():
    """
    Accepts any incoming client connection
...
def read_incoming_packet(client, packet):
    """
    Handle incoming packets to identify the protocol they are related to, and then redirects to response functions that will generate the
...
def answer_login(client, query):
    ...
    allow handling of multiple devices at one
